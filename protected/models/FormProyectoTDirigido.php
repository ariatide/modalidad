 ...
 */
class FormProyectoTDirigido extends CFormModel {
    ...
    public function rules() {
        return array(
            array('titulo,areaJuridica,numeroConvenio,modalidad,estado', 'required'), //  objetivoGeneral, objetivosEspecificos
            array('fechaRegistro', 'date', 'format' => Yii::app()->locale->getDateFormat()),
            array('observaciones,departamento,provincia,seccion,tutorId, nombreSupervisor,lugarEjecucion,tutor, lugarEjecucionId', 'safe')
        );
    }
        ...
        return new CForm(array(
            ...
            'elements' => array(
                ...
                'lugarEjecucion' => array(
                    ...
                    'placeholder' => 'Lugar Ejecucion',
                    'size' => 60
                ),
                'lugarEjecucionId' => array(
                    'label' => 'Lugar Ejecucion Id',
                    'type' => 'hidden',
                ),
                'provincia' => array(
                    'label' => 'Provincia',
                ...
                'fechaRegistro' => array(
                    'label' => 'Fecha Aprobacion de Perfil',
                    'class' => 'datepicker',
                ),
                /*
                  'modalidad'=>array(
