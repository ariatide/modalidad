 ...
 */
class FormAdscripcion extends CFormModel {
    ...
    public $documento;
    public $subscripcionConvenio;

    public function rules() {
        return array(
            array('subscripcionConvenio', 'required'),
            array('primerInformeAvance,primeraListaCotejo,informeFinal,informeFinalForma,subscripcionConvenio', 'date', 'format' => Yii::app()->locale->getDateFormat()), //primerInformeAvance
