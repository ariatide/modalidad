...
class Zend_Search_Lucene_Document_Html extends Zend_Search_Lucene_Document
{
    ...
    public function highlightExtended($words, $callback, $params = array())
    {
		...
		// Noemi: Codigo agregado para correegir el erro que ocurrida al llamar al metodo highlightMatches
		// a la hora de mostrar los resultados realizados por una busqueda difusa
		if (count($words) == 0) {
